...
- **Comments**: Follow the repository-wide rule to document intent, not mechanics. Do not comment on a locator or assertion when its title already explains it; update or remove stale comments when the test changes.
...
- [ ] Code follows the documented TypeScript formatting rules and comments explain intent rather than restating code
