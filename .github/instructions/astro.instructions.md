...
- Define a documented `Props` interface in frontmatter for every reusable component; describe the component contract and any non-obvious prop constraints with TSDoc.
...
- Comment why a component needs non-obvious markup or client behavior; do not use comments to repeat the HTML or Astro expression immediately below them.
- Keep component comments and `Props` documentation synchronized with the implementation.
