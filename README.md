...
The game listing includes accessible category and publisher filters. Because the site is
fully static, filter selections are applied to the pre-rendered cards in the browser and
are reflected in the URL so filtered views can be shared.
